                ...
                <form action="{{ route('peran.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-9 col-xl-9">
                            <input type="text" class="form-control @error('role') is-invalid @enderror" id="role" name="role" value="{{ old('role') }}" placeholder="Silahkan isi dengan Kode Peran" required>
                            @error('role')
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-9 col-xl-9">
                            <input type="text" class="form-control @error('nm_role') is-invalid @enderror" id="nm_role" name="nm_role" value="{{ old('nm_role') }}" placeholder="Silahkan isi dengan Nama Peran" required>
                            @error('nm_role')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-2">
                                            <div class="form-check form-switch">
                                                <input type="checkbox" class="form-check-input" id="{{ $value1->id }}" name="hak_akses[]" value="{{ $value1->id }}">
                    ...
                    <div class="justify-content-end row" style="float: right;"> 
                        <div class="col-12 col-xl-12">
                            ...
                            <a href="{{ route('peran.index') }}" class="btn btn-warning rounded-pill btn-md">Kembali</a>
                        </div>
                    </div>
                </form>
            </div>
